...
public class Over extends Group {
    private Scene scene;
    private Text text;
    private Game game;
    private Text text1;
    public MediaPlayer mediaPlayer;
    public String path = "src/main/resources/gameOver.mp3";
    public Media media;
    public MediaPlayer mediaPlayer1;
    public MediaView mediaView;
    public Group root;
    public Over(Group root, Scene scene, int score) {
        this.root = root;
        this.scene = scene;
        ...
        this.text = new Text(String.format("Your score: %d", score));
        text.getStyleClass().add("menu-Text");

        this.text1 = new Text("  Play again ");
